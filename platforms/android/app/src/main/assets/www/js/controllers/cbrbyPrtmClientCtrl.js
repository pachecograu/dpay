MyApp.angular.controller('cbrbyPrtmClientCtrl', ['$scope', '$rootScope', '$stateParams', '$filter', '$state', function ($scope, $rootScope, $stateParams, $filter, $state) {
  console.log('en el cbrbyPrtmClientCtrl', $stateParams);
  ...
  try {
    ...
    var calendarInlineClient = MyApp.fw7.calendar.create({
      containerEl: '#demo-calendar-inline-container-client',
      value: [new Date()],
      ...
      on: {
        init: function (c) {
          ...
          $$('.calendar-custom-toolbar .left .link').on('click', function () {
            calendarInlineClient.prevMonth();
          });
          $$('.calendar-custom-toolbar .right .link').on('click', function () {
            calendarInlineClient.nextMonth();
          });
        },
